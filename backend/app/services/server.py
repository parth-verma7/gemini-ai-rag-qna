...
from utils import vectorstore_embeddings, gemini_response, guardrail
...
def query_results(query):
    ...
    query_check = guardrail.guardrail_check(query)
    if(query_check[0])=="negative": return query_check[1]
